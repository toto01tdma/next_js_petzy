    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            if (!USE_API_MODE) {
                ...
                showSuccess('สำเร็จ (โหมดพรีวิว)', 'อัปโหลดนโยบายความเป็นส่วนตัวเรียบร้อยแล้ว');
                
                // Create mock policy data for preview
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            if (!USE_API_MODE) {
                // Preview mode - simulate success
                await new Promise(resolve => setTimeout(resolve, 500));
                showSuccess('สำเร็จ (โหมดพรีวิว)', 'ลบนโยบายความเป็นส่วนตัวเรียบร้อยแล้ว');
                setPolicyData(null);
                setSelectedFile(null);
                setLoading(false);
                return;
